...
void usage( int argc, char** argv )
{
    ...
    std::cerr << "\t - Example: " << argv[ 0 ] << "1.0 7.0 0.01 0.05 0.05 0.01 accflower" << std::endl;
}
...
int main ( int argc, char** argv )
{
    ...
    double min_radius_shape = 1.00217;
    MyShape shape( 0, 0, max_radius_shape, min_radius_shape, 3, 0.0 ); //AccFlower
//    MyShape shape( 0, 0, max_radius_shape, min_radius_shape, 4, 0.0 ); //Flower
