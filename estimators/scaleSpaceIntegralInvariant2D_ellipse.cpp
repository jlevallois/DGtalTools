...
typedef Ellipse2D< Z2i::Space > MyShape;
...
void usage( int argc, char** argv )
{
    ...
    std::cerr << "\t - Example: " << argv[ 0 ] << "1.0 7.0 0.01 0.05 0.05 0.01 ellipse" << std::endl;
}
...
int main ( int argc, char** argv )
{
    ...
    double min_radius_shape = 7.00217;
    MyShape shape( 0, 0, max_radius_shape, min_radius_shape, 3.0 ); //Ellipse
